-- Add legenda columns
ALTER TABLE public.promocoes_goodzap ADD COLUMN IF NOT EXISTS legenda text;
ALTER TABLE public.recuperacao_clientes ADD COLUMN IF NOT EXISTS legenda text;
ALTER TABLE public.promocao_aniversario ADD COLUMN IF NOT EXISTS legenda_1 text;
ALTER TABLE public.promocao_aniversario ADD COLUMN IF NOT EXISTS legenda_2 text;
ALTER TABLE public.promocao_aniversario ADD COLUMN IF NOT EXISTS legenda_3 text;

-- Update RPC to include legendas in payload
